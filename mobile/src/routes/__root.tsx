  ...
  head: () => ({
    meta: [
      ...
      { title: "MyDesignGhar — AI Interior Design for India" },
      {
        name: "description",
        content:
          "MyDesignGhar redesigns any room in seconds with AI, featuring 26 Indian regional styles and real interior designers.",
      },
      { name: "author", content: "MyDesignGhar" },
      { name: "theme-color", content: "#FF6B35" },
      { property: "og:title", content: "MyDesignGhar — AI Interior Design for India" },
      {
        property: "og:description",
        content: "Transform any room in seconds with AI and 26 Indian regional styles.",
      },
...
const themeScript = `(function(){try{var t=localStorage.getItem('mdg-theme');var d=t? t==='dark' : window.matchMedia('(prefers-color-scheme: dark)').matches;if(d)document.documentElement.classList.add('dark');}catch(e){}})();`;
